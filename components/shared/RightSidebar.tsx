...
const RightSidebar = () => {
  return <section className="background-light900_dark200 light-border light-border-sticky left-0 top-0 flex h-[100dvh] flex-col justify-between overflow-y-auto border-l p-6 pt-36 shadow-light-300 dark:shadow-none max-lg:hidden lg:w-[350px]">
    <div>
